...
class COCOWrapper(object):
    ...
    def __init__(self, split, fold=0, image_size=400, aug=None, mask='separate', negative_prob=0,
        ...
        self.coco = DatasetCOCO(expanduser('D:\clipseg\datasets\COCO-20i'), fold, transform, split, 1, False)
        self.all_classes = [self.coco.class_ids]
        self.coco.base_path = join(expanduser('D:\clipseg\datasets\COCO-20i'))
