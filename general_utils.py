...
def training_config_from_cli_args():
    # experiment_name = sys.argv[1] # pascal_1shot.yaml 获取命令行参数
    experiment_name = "pascal_1shot.yaml"
    # experiment_id = int(sys.argv[2]) # 0 获取命令行参数
    experiment_id = 0
    yaml_config = yaml.load(open(f'experiments/{experiment_name}', encoding='utf-8'), Loader=yaml.SafeLoader)
